...
expect(detect_format(eviatlas)=="parse_ris", "RIS file not being detected")

expect(detect_format(litsearchr)=="parse_bibtex", ".bib file not being detected")

expect(detect_format(res_synth_methods)=="parse_pubmed", "PubMed nbib file not being detected")
