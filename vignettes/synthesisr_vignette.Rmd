...
bibfiles <- list.files(system.file("extdata/", package = "synthesisr"), full.names = TRUE)
...
imported_files <-  synthesisr::read_refs(filename = bibfiles, 
                                         return_df = TRUE)
...
df <- synthesisr::deduplicate(imported_files,
                              match_by = "title",
...
manual_checks <- synthesisr::review_duplicates(df$title, duplicates_string)
...
results <- synthesisr::extract_unique_references(df, new_duplicates)
