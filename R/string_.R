...
#' @description These functions each access a specific \code{"methods"} argument provided by \code{\link{stringdist}}, and are provided for convenient calling by \code{\link{find_duplicates}}. They do not include any new functionality beyond that given by \code{\link{stringdist}}, which you should use for your own analyses.
